<template>
  <section class="wrap">
    <article class="content">
      <el-form :model="ruleForm" status-icon :rules="rules" label-position="left" ref="ruleForm" label-width="80px" class="demo-ruleForm">
        ...
        <el-form-item label="密码" prop="secret">
          <el-input type="password" placeholder="请输入邮箱"  v-model="ruleForm.secret" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
